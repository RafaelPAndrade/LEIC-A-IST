...
#17--> usado a inversa, concebido no 12, e strings.
"""
...
#20->muito trabalhoso, forma mais elegante
"""
...
#21-1ª tentativa
#Será batota? Está a dar erro->última base_mult dá 123456788
"""
base_mult= 1.23456789 #o int() *10**(n) deste número vai dando coisas fixes

n=1 #nº da linha, vai de 1 a 9


while n <= 9:
	resultado = (int(base_mult)*8)+n
	print(int(base_mult), "x", 8, "+", n, "=", resultado)
	base_mult = base_mult*10
	n= n+1
"""

#21-2ªtentativa->certo
